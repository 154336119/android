...
public class OrderSubmitTask extends AbstractHttpTask<Order> {
    ...
    public OrderSubmitTask(Context context,String mobile,String housing_id,String housing_name,String housing_address
        ...
        mRequestParams.put("source", "hz-android");
        ...
        mRequestParams.put("version", ZxsqApplication.getInstance().getVersionName());
    }

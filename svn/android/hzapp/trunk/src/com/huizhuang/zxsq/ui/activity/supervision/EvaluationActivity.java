    ...
    private void initActionBar() {
        ...
        mCommonActionBar.setRightImgBtn(R.drawable.ic_actionbar_share, new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Share share = new Share(EvaluationActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_submit:
                switch (Integer.valueOf(mNodeId)) {
                    case 1:
                        AnalyticsUtil.onEvent(THIS, AppConstants.UmengEvent.ID_CLICK_0032);
                        break;
                    case 2:
                        AnalyticsUtil.onEvent(THIS, AppConstants.UmengEvent.ID_CLICK_0035);
                        break;
                    case 3:
                        AnalyticsUtil.onEvent(THIS, AppConstants.UmengEvent.ID_CLICK_0038);
                        break;
                    case 4:
                        AnalyticsUtil.onEvent(THIS, AppConstants.UmengEvent.ID_CLICK_0041);
                        break;
                    case 5:
                        AnalyticsUtil.onEvent(THIS, AppConstants.UmengEvent.ID_CLICK_0044);
                        break;
                    default:
                        break;
                }

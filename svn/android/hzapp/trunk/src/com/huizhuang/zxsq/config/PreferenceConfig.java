...
public class PreferenceConfig{
	...
	public static final String RETURN_HOME_FROM_LOGIN_OUT = "return_home_activity_from_login_out";
	/** 获取安装版本号 */
	...
	/**得到当前APP是否是从登录状态返回HomeActivity*/
	public static boolean getReturnHomeFromLoginOut(){
		return PrefersUtil.getInstance().getBooleanValue(RETURN_HOME_FROM_LOGIN_OUT, false); 	
	}
	/**保存当前APP是否是从登录状态返回HomeActivity*/
	public static void setReturnHomeFromLoginOut(boolean is){
		PrefersUtil.getInstance().setValue(RETURN_HOME_FROM_LOGIN_OUT, is);
	}
	/**保存当前APP是否已经评过分*/
	...
	/**设置工长，以便确定分享文案*/
	public static void setShareByForeman(boolean bool){
		PrefersUtil.getInstance().setValue(SHARE_BY_FOREMAN, bool);
	}
	
	/**得到工长，从而确定分享文案*/
	public static boolean getShareByForeman(){
		return PrefersUtil.getInstance().getBooleanValue(SHARE_BY_FOREMAN,false);
	}
	/**设置工长的名字，以便确定分享文案*/
	public static void setShareByForemanName(String foremanName){
		PrefersUtil.getInstance().setValue(SHARE_BY_FOREMAN_NAME, foremanName);
	}
	/**得到工长的名字，从而确定分享文案*/
	...
	/**设置登录得时候的发送验证码的号码*/
	public static void setSendVerifyNumberByLogin(String number){
		PrefersUtil.getInstance().setValue(SEND_VERIFY_NUMBER_BY_LOGIN, number);
	}
	/**得到登录得时候的发送验证码的号码*/

...
//	public static DisplayImageOptions optionsMyMessageHeader = getDisplayImageOptions(R.drawable.ic_my_messages_header, HEADER_CORNER_RADIUS_PIXELS);
	 ...
	 * 用户头像
	 */
	public static DisplayImageOptions optionsUserHeader = getDisplayImageOptions(R.drawable.ic_default_header, HEADER_CORNER_RADIUS_PIXELS);
    ...
    /**
     * 施工列表图片的DisplayImageOptions
     */
    public static DisplayImageOptions optionsSolutionList = getSolutionListDisplayImageOptions(true,true);
	...
	/**
	 * 
	 * @param cacheInMemory 是否在内存中缓存
	 * @param cacheInDisk 是否在SD卡中缓存
	 * @return 施工现场列表的DisplayImageOptions
	 */
	public static DisplayImageOptions getSolutionListDisplayImageOptions(boolean cacheInMemory,boolean cacheInDisk) {
		DisplayImageOptions.Builder builder = new DisplayImageOptions.Builder();
		builder.cacheInMemory(cacheInMemory);
		builder.cacheOnDisk(cacheInDisk);

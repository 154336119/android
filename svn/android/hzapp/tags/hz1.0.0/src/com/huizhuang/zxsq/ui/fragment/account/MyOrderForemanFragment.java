...
import com.huizhuang.zxsq.ui.fragment.account.MyOrderCompanyFragment.RefreshReceiver;
...
*  
*/
public class MyOrderForemanFragment extends BaseFragment {
    ...
    private void httpRequestQueryOrderData(final XListRefreshType xListRefreshType){
    	GetOrderListTask task = new GetOrderListTask(getActivity(),Order.ORDER_TYPE_FOREMAN,mMinId);

 ...
 */
public class ForemanCommentsUpTask extends AbstractHttpTask<CommentResult> {

    public ForemanCommentsUpTask(Context context, String comment_id){
        super(context);
    ...
    public String getUrl() {
        return HttpClientApi.BASE_URL + HttpClientApi.URL_FOREMAN_COMMENTS_UP;
    }

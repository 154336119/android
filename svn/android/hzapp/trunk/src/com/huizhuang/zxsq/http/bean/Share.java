...
public class Share implements Serializable {
	...
	public Share(Context context) {
		...
		title = context.getResources().getString(R.string.txt_share_title);//默认按照微信平台来设置text和title
		if(PreferenceConfig.getShareByForeman()){
			text = context.getResources().getString(R.string.txt_share_from_foreman_front)
					+PreferenceConfig.getShareByForemanName()
					+context.getResources().getString(R.string.txt_share_from_foreman_behind);
			//PreferenceConfig.setShareByForeman(false);
		}else if(PreferenceConfig.getShareByOrderState()==AppConstants.SHARE_BY_ORDER_COMMON){
			text = context.getResources().getString(R.string.txt_share_common);
		}else if(PreferenceConfig.getShareByOrderState()==AppConstants.SHARE_BY_ORDER_START_WORKING){
			text = context.getResources().getString(R.string.txt_share_start_working);
		}else if(PreferenceConfig.getShareByOrderState()==AppConstants.SHARE_BY_ORDER_WATER){
			text = context.getResources().getString(R.string.txt_share_water);
		}else if(PreferenceConfig.getShareByOrderState()==AppConstants.SHARE_BY_ORDER_WOOD){
			text = context.getResources().getString(R.string.txt_share_wood);
		}else if(PreferenceConfig.getShareByOrderState()==AppConstants.SHARE_BY_ORDER_PAINT){
			text = context.getResources().getString(R.string.txt_share_paint);
		}else if(PreferenceConfig.getShareByOrderState()==AppConstants.SHARE_BY_ORDER_COMPLETE){
			text = context.getResources().getString(R.string.txt_share_complete);
		}

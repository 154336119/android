 ...
 */
public class ForemanCommentsTask extends AbstractHttpTask<List<ForemanComment>> {

    public ForemanCommentsTask(Context context, String foreman_id){
        super(context);
//        mRequestParams.add("comment_key", "jl_gongzhang" );

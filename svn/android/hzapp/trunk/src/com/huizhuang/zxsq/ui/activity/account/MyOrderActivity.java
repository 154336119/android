...
public class MyOrderActivity extends BaseActivity implements OnClickListener{
    ...
    private void httRequestGetComplaintsNode(){
        ComplaintsNodeTask getOrderListTask = new ComplaintsNodeTask(this);
        getOrderListTask.setCallBack(new AbstractHttpResponseHandler<List<ComplaintsNode>>() {
            @Override
	...
	@Override
	public void onClick(View v) {
		AnalyticsUtil.onEvent(MyOrderActivity.this, AppConstants.UmengEvent.ID_CLICK_0071);
    	Bundle bundle = new Bundle();
    	bundle.putString(AppConstants.PARAM_ORDER_SOURCE_NAME, "app_order_list");
		ActivityUtil.checkAppointmentToJump(MyOrderActivity.this, bundle);
	}

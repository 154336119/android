 ...
 * 
 */
public class OrderCancelAppointmentReasonListActivity extends BaseActivity implements OnClickListener {
    ...
    private void initActionBar() {
        ...
        mCommonActionBar.setActionBarTitle("取消预约");
    ...
    private void httpRequestSubmit(){
        ...
        OrderCancelAppointmentSubmitTask task = new OrderCancelAppointmentSubmitTask(OrderCancelAppointmentReasonListActivity.this,mOrdersId,mAdapter.getSelectName(),content);
    ...
    private void httpRequestQueryCancelReason() {
        OrderCancelAppointmentTask task = new OrderCancelAppointmentTask(OrderCancelAppointmentReasonListActivity.this, mOrdersId);

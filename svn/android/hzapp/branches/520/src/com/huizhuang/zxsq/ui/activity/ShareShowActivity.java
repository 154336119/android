...
*/		
		...
		if (SinaWeibo.NAME.equals(platformName)) {//新浪微博
			String text = new String();
				if(PreferenceConfig.getShareByOrderState()==AppConstants.SHARE_BY_ORDER_COMMON){
					text = "#惠装工长#【我是惠装，比装修公司省40%，工薪阶层的装修首选！】"

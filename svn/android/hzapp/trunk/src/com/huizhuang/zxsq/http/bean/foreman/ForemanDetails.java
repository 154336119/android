...
public class ForemanDetails {
    ...
    public int getOrder_done_count() {
        return order_done_count;
    }

    public void setOrder_done_count(int order_done_count) {
        this.order_done_count = order_done_count;
    }
    ...
    public void setNew_comment(ForemanComment new_comment) {
    ...
    public String toString() {
        return "ForemanDetails [store_id=" + store_id + ", is_auth=" + is_auth + ", full_name="
                ...
                + logo + ", order_done_count=" + order_done_count + ", showcase=" + showcase

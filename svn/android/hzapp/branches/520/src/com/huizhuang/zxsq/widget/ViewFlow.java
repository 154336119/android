...
public class ViewFlow extends AdapterView<Adapter> {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        switch (heightMode) {
            ...
            case MeasureSpec.AT_MOST:
                heightSize =
                        (childHeight + heightPadding) | (childState >> MEASURED_HEIGHT_STATE_SHIFT);
                break;
            case MeasureSpec.EXACTLY:
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mTouchState == TOUCH_STATE_SCROLLING) {
                    ...
                    if (deltaX < 0) {
                        ...
                        final int
                                availableToScroll =
                                getChildAt(getChildCount() - 1).getRight() - getPaddingRight()
            ...
            case MotionEvent.ACTION_UP:
                if (mTouchState == TOUCH_STATE_SCROLLING) {
                    ...
                    performItemClick(mLoadedViews.get(mCurrentBufferIndex),
                            mCurrentAdapterIndex % mValideCount, 0);
                }
    ...
    protected void onScrollChanged(int h, int v, int oldh, int oldv) {
        ...
        if (mIndicator != null) {
			 ...
			 */
            int hPerceived = h + (mCurrentAdapterIndex % mValideCount - mCurrentBufferIndex) * getChildWidth();

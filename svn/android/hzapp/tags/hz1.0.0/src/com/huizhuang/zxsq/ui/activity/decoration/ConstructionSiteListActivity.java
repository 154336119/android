...
/** 
* @ClassName: ConstructionSiteListActivity 
* @Description: 施工现场列表
* @author th 
...
*  
*/
public class ConstructionSiteListActivity extends BaseActivity {
...
//	private int mPageIndex = AppConfig.DEFAULT_START_PAGE;
    ...
    public void onCreate(Bundle savedInstanceState) {  
        ...
        setContentView(R.layout.activity_construction_site_list);
        initVews();
        initXlistView();
    }  
...
//				httpRequestQueryDiaryList(XListRefreshType.ON_LOAD_MORE);
		...
		mAdapter = new ConstructionSiteListAdapter(ConstructionSiteListActivity.this);

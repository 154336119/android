...
public class OrderAppointmentSignedActivity extends BaseActivity {
    ...
    private void initActionBar() {
        ...
        mCommonActionBar.setRightTxtBtn(R.string.txt_complaints, new OnClickListener() {
            ...
            public void onClick(View arg0) {
                AnalyticsUtil.onEvent(THIS, AppConstants.UmengEvent.ID_CLICK_0051);
                httpRequestComplaintsInfo(mOdersId, Util.getIdByComplaintsName(AppConstants.COMPLAINTS_APPOINTMENT));
            }
        });
    }
    ...
    private void httpRequestComplaintsInfo(String orders_id,final String dispute_node_id) {
        ComplaintsInfoTask task =
                new ComplaintsInfoTask(OrderAppointmentSignedActivity.this, orders_id,dispute_node_id);
        task.setCallBack(new AbstractHttpResponseHandler<ComplaintsData>() {
            ...
            public void onSuccess(ComplaintsData result) {
                if(result.getStauts() == 0){//无投诉
                    ...
                    ActivityUtil.next(OrderAppointmentSignedActivity.this, ComplaintsListActivity.class,bd,-1);
                }else{//有投诉
                    Bundle bd = new Bundle();
                    ...
                    ActivityUtil.next(OrderAppointmentSignedActivity.this, ComplaintsSucessActivity.class,bd,-1);
                }
            }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                case 0:// 取消签约
                    ...
                    break;
                case 1:// 签约
                	AnalyticsUtil.onEvent(OrderAppointmentSignedActivity.this, UmengEvent.ID_CLICK_0026);

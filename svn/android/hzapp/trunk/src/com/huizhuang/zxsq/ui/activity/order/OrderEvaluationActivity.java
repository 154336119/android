...
public class OrderEvaluationActivity extends BaseActivity {
    ...
    private void initActionBar() {
        ...
        mCommonActionBar.setRightTxtBtn(R.string.txt_complaints, new OnClickListener() {
            ...
            public void onClick(View arg0) {
                AnalyticsUtil.onEvent(THIS, AppConstants.UmengEvent.ID_CLICK_0050);
				httpRequestComplaintsInfo(mOdersId, Util.getIdByComplaintsName(AppConstants.COMPLAINTS_EVALUATION));
            }
        });
    }
    ...
    private void httpRequestComplaintsInfo(String orders_id,final String dispute_node_id) {
        ComplaintsInfoTask task =
                new ComplaintsInfoTask(OrderEvaluationActivity.this, orders_id,dispute_node_id);
        task.setCallBack(new AbstractHttpResponseHandler<ComplaintsData>() {
            ...
            public void onSuccess(ComplaintsData result) {
                if(result.getStauts() == 0){//无投诉
                    ...
                    ActivityUtil.next(OrderEvaluationActivity.this, ComplaintsListActivity.class,bd,-1);
                }else{//有投诉
                    Bundle bd = new Bundle();
                    ...
                    ActivityUtil.next(OrderEvaluationActivity.this, ComplaintsSucessActivity.class,bd,-1);
                }
            }

...
public class CalendarHelper {
	...
	public static HashMap<DateTime, Integer> getDateToDates(Date fromDate, Date toDate, int res) {
		HashMap<DateTime, Integer> selectedDates = new HashMap<DateTime, Integer>();
		...
		while (dateTime.lt(toDateTime)) {
			selectedDates.put(dateTime,res);
			dateTime = dateTime.plusDays(1);
		}
		selectedDates.put(toDateTime, res);

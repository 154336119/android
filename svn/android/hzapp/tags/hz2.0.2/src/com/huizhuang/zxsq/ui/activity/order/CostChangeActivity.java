...
public class CostChangeActivity extends BaseActivity implements OnClickListener {
    ...
    private void setViewData(CostChange costChange) {
    	...
    	if(TextUtils.isEmpty(costChange.getDed_cost_total())){
            mCostAll.setText(costChange.getAdd_cost_total());
        }else if(TextUtils.isEmpty(costChange.getAdd_cost_total())){
            mCostAll.setText(costChange.getDed_cost_total());
        }else{
            Float addTotal = Float.valueOf(costChange.getAdd_cost_total());
            Float desTotal = Float.valueOf(costChange.getDed_cost_total());
            if(desTotal > addTotal){
                mCostAll.setText((desTotal - addTotal)+"");
            }else{
                mCostAll.setText((addTotal - desTotal)+"");
            }
        }

...
import com.huizhuang.zxsq.ui.adapter.decoration.DesignSchemeListAdapter;
...
/** 
* @ClassName: DesignSchemeListActivity 
* @Description: 设计方案列表
* @author th 
...
*  
*/
public class DesignSchemeListActivity extends BaseActivity {
	
	private DataLoadingLayout mDataLoadingLayout;
	private XListView mXListView;
	private DesignSchemeListAdapter mAdapter;
...
//	private int mPageIndex = AppConfig.DEFAULT_START_PAGE;
    ...
    public void onCreate(Bundle savedInstanceState) {  
        ...
        setContentView(R.layout.activity_design_scheme_list);
        initVews();
        initXlistView();
    }  
...
//				httpRequestQueryDiaryList(XListRefreshType.ON_LOAD_MORE);
		...
		mAdapter = new DesignSchemeListAdapter(DesignSchemeListActivity.this);

...
public class ConstructionSiteDetails {
	...
	public String toString() {
		return "ConstructionSiteDetails [id=" + id + ", housing_name="
				+ housing_name + ", name=" + name + ", cost=" + cost
				+ ", renovation_way=" + renovation_way + ", door_model="
				+ door_model + ", area=" + area + ", room_style=" + room_style
				+ ", phrase=" + phrase + ", order_count=" + order_count
				+ ", image=" + image + ", subcases=" + subcases + ", data="
				+ data + ", store_id=" + store_id + ", budget=" + budget + "]";
	}

...
//    private TextView mTvAppointmentTxt;
    ...
    private LinearLayout mLinExperience;
...
//        mTvAppointmentTxt = (TextView) findViewById(R.id.tv_appointment_txt);
        ...
        mLinAddress = (LinearLayout) findViewById(R.id.lin_address);
        mLinExperience = (LinearLayout) findViewById(R.id.lin_experience);
        mRlAllComment = (RelativeLayout)findViewById(R.id.rl_all_comment);
        mVComment = (View)findViewById(R.id.v_comment);
    ...
    private void initStubViewSite() {
        ...
        mIvSiteImg1.setImageBitmap(bitmap1);
        mBits.add(bitmap1);
        ...
        mIvSiteImg2.setImageBitmap(bitmap2);
        mBits.add(bitmap2);
...
//        });
    ...
    private void initStubViewPrice() {
        ...
        Bitmap bitmap = ImageUtil.readBitMap(this, R.drawable.bg_foreman_lower_price);
    ...
    private void initStubViewSafety() {
        ...
        Bitmap bitmap = ImageUtil.readBitMap(this, R.drawable.bg_foreman_safety);
        mScreenWidth = UiUtil.getScreenWidth(ForemanDetailsActivity.this);
    ...
    private void initData(ForemanDetails foremanDetails) {
        ...
        if (TextUtils.isEmpty(foremanDetails.getExperience())) {
            mLinExperience.setVisibility(View.GONE);
        } else {
            mLinExperience.setVisibility(View.VISIBLE);
        }
        ...
        if(foremanDetails.getComment_count() > 0){
            ...
            mRlAllComment.setVisibility(View.VISIBLE);
            mVComment.setVisibility(View.VISIBLE);
        }else{
            mRlAllComment.setVisibility(View.GONE);
